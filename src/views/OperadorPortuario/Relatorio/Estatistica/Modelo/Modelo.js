...
class Modelo extends Component {
    ...
    gerarPdf() {    
        ...
        // var dataAtual = Date();
        //         dataAtual = new Date(dataAtual).toLocaleDateString();
        //         dataAtual = dataAtual.split(' ').slice(0, 4).join(' ');            
            ...
            header: function(){
                return  {
                        ...
                        columns: [
                                ...
                                [
                                    {
                                        text:'Periodo de Operação: 10/11/2017' + ' a ' + '20/11/2017', 
                                        style:'subTituloStyle',
                                        margin:[-150,20,0,0],
                                        
                                    },
                                    {
                                        text:'Total:  ' + 'Requisitante/Navio/Cliente',
                                        style:'subTituloStyle',     
                                        margin:[-150,0,0,0],                                   
                                    }
                                ],
                    ...
                    widths: [
                        ...
                        body:[
                            ...
                            [
                                ...
                                { 
                                    text:'8068 -SIRIUS LEADER / 34 - POSEIDON MARITIMA LTDA', 
                                    style: 'reqNavStyle',
                                    border:[false,false,false,false],
                                    margin:[-5,0,0,5],
                                    colSpan: 31,
                            ...
                            [
                                ...
                                {
                                    text: 'Requisições: 249230 249230',
                                    style: 'atividadeStyle',
                                    bolt:'true',
                                    border:[false,true,true,true], 
                                    colSpan: 4,
